...
const bgIncrement = Math.round(100 / ((content.offsetWidth / content.parentElement.offsetWidth) - 1)); //distance the bg has to travel between slides
...
function move(direction) {
  ...
  document.body.style.backgroundPosition = bgOffset + "% 70%";
}
